...
function ImgCardSection() {
  ...
  return (
    <section>
      <h1 className='text-center text-[#26395C] text-2xl sm:text-3xl lg:text-4xl font-bold mt-10 mb-10'>What are you in the mood for?</h1>
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 mt-5 mb-10 container mx-auto p-4">
        {
            cards.map((card, index)=> (
                <div key= {index} className='flex flex-col items-center overflow-hidden'>
                    ...
                    <div>
                        <h2 className='text-2xl sm:text-3xl mt-2 lg:mt-4 lg:mb-5 mb-3 text-[#26395C] font-bold'>{card.title}</h2>
                    </div>
