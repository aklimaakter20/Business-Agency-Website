                ...
                <div className='flex items-center justify-between'>
                    ...
                    <div className='flex flex-col lg:flex-row items-center gap-6 w-full px-12'>
                        <div className='w-full lg:1/2'>
                            <h3 className='text-3xl font-semibold text-[#26395C] lg:ms-10 text-center'>Upcoming Eat & Drink Events</h3>
                            <img className='object-cover w-full h-fit' src={currentSlider.image} alt="" />
                        </div>
                        <div className='w-full lg:w-1/2 flex flex-col gap-4'>
                            <h2 className='text-2xl lg:text-4xl font-bold lg:w-[100%] leading-tight text-[#26395C]'>{currentSlider.heading}</h2>
