...
<div className='bg-[#FBFCFF] w-full h-auto lg:w-[750px] lg:h-[150px] px-5 py-5 lg:py-10 lg:px-10 lg:ms-10 rounded-xl'>
  ...
  <Autocomplete labelPlacement='outside' label= "Location" placeholder='Oshodi' className='w-[100%]'>
    <AutocompleteItem value="Hablu programmer">Oshodi</AutocompleteItem>
        ...
        <AutocompleteItem value="Hablu programmer">Hablu Programmer</AutocompleteItem>
        <AutocompleteItem value="Stack Learner">Stack Learner</AutocompleteItem>

    </Autocomplete>
    
  </div>
  <div>
  <Autocomplete labelPlacement='outside' label= "Date" placeholder='Date' className='w-[100%]'>
    <AutocompleteItem value="Hablu programmer">Oshodi</AutocompleteItem>
  ...
  <div>
  <Autocomplete labelPlacement='outside' label= "Activities" placeholder='Night Clubs' className='w-[100%]'>
    <AutocompleteItem value="Hablu programmer">Oshodi</AutocompleteItem>
  ...
  <div>
  <Button color='primary' className='py-7 w-full mt-2'>Search</Button>
