...
function ThingsCard() {
  ...
  return (
    <section className='bg-[#F5FAFF] p-5'>
        ...
        <h1 className='text-center lg:text-start text-[#26395C] text-2xl sm:text-3xl font-bold mt-10 mb-2'>Top things to do in Lagos</h1>
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 mt-5 mb-10">
        {
            cards.map((card, index)=> (
                <div key= {index} className='flex flex-col items-center overflow-hidden'>
                    ...
                    <div>
                        <h2 className='text-lg sm:text-xl mt-2 lg:mt-1 lg:mb-5 mb-3 text-[#26395C] font-bold'>{card.title}</h2>
                    </div>
